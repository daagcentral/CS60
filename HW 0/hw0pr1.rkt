...
(define (elle n m color1 color2 color3)
  (let* ([c1 (colorize (filled-ellipse n m) color1)]  
         [c2 (colorize (filled-ellipse n m) color2)]
         [c3 (colorize (filled-ellipse n m) color3)]
         [cc (niner c1 c2 c3)]
         [c9 (nine cc)])
  (nine c9))) 
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; You'll type this directly in Gradescope
; Is racket used on an industrial level or is it meant just for teaching?
...
(define (circlee)
  (vc-append 10
             ...
             (hc-append 10
                        ...
                        (ellipse 3 40)
                        (nine (nine (circle 2))))
             (colorize (filled-ellipse 100 2) "red")))
